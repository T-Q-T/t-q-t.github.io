export const DATA = {
  cn: {
    current: [
      ...
      {
        sentence:"所有命运赠中的馈赠，早已在暗中标上了价码。",
        name:"茨威格"
      },
      {
        sentence:"只有让人看到价值，那才有资格成为朋友。一昧的祈求别人的给予，只能称之为乞丐。"
      },
      {
      ...
      {
        sentence:"懒惰这种东西，一旦开了一个头，就会使你越来越软弱,直到消磨完你的斗志，永远的把你禁锢到山的底部。"
      },
      {
        sentence:`人害怕失败，因为失败会让人感到羞耻，羞耻则会使人变弱，羞耻感会让人操作变形。哪怕面对下一个机遇时，也会因为羞耻感而不敢前进。
        将失败当成你所行之路的试炼，凡事发生皆利于我，那么便会成为某种意义上的无敌之人。`
      },
      {
        sentence:"文字和语言是打醒一个人成本最低的方式，而经历灾难，是打醒一个人，成本最大，见效最快的方式。"
      }
    ],
    zhuangzi: [
      {
